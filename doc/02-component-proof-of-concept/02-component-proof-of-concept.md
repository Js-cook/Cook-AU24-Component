...
The design that I will likely proceed with is Stat-calc. This component most appeals to me functionality-wise and as someone who is taking stats during this project, I think that I will have a lot of the necessary theory and information required to implement it. Additionally, due to the numerical nature of the data used with this component, testing can be simplified and wouldn't require a ton of setup beforehand.
